...
import dev.meoray.client.util.math.TimerUtil;
...
public abstract class Animation {
    ...
    public void reset() { this.timerUtil.reset(); }

    public boolean isDone() { return this.timerUtil.isReached((long) this.duration); }

    public void changeDirection() { this.setDirection(this.direction.opposite()); }
