package dev.meoray.client.util.render.msdf;
...
public final class FontData {
    ...
    public AtlasData atlas() { return this.atlas; }
    public MetricsData metrics() { return this.metrics; }
    public List<GlyphData> glyphs() { return this.glyphs; }
    public List<KerningData> kernings() { return this.kernings; }
    ...
    public static final class MetricsData {
        ...
        public float lineHeight() { return this.lineHeight; }
        public float ascender() { return this.ascender; }
        public float descender() { return this.descender; }
        public float baselineHeight() { return this.lineHeight + this.descender; }
    }
    ...
    public static final class GlyphData {
        ...
        public BoundsData planeBounds() { return this.planeBounds; }
        public BoundsData atlasBounds() { return this.atlasBounds; }
    }
    ...
    public static final class KerningData {
        ...
        private float advance;
        public int leftChar() { return this.leftChar; }
        public int rightChar() { return this.rightChar; }
        public float advance() { return this.advance; }
    }
}
