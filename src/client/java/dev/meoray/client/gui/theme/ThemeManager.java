...
public class ThemeManager {
    ...
    private final Theme[] themes = {
        ...
        new Theme("Neon Cyan",
            0xFF001A1A, 0xFF002828, 0xFF00FFE0,
            0x33003333, 0xFFCCFFFF, 0xFF66CCCC, 0xFF003F3F,
            0xFF002626, 0xFF000F0F),
        new Theme("Lava",
            0xFF1A0500, 0xFF2A0A05, 0xFFFF3D00,
            0x66331100, 0xFFFFCCAA, 0xFFCC8866, 0xFF3F1A0A,
            0xFF2A0A00, 0xFF150500),
        new Theme("Mono",
            0xFF101010, 0xFF181818, 0xFFE0E0E0,
            0x33222222, 0xFFF5F5F5, 0xFF888888, 0xFF1A1A1A,
            0xFF141414, 0xFF0A0A0A)
    };
